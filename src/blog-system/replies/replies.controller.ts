...
export class RepliesController {
    ...
    async addReply(
        ...
        const reply = await this.repliesService.addReply(
            createReplyDto,
            reply_by,
            reply_to,
            comment_id,
    ...
    @AUTH(AuthEnum.BEARER)
    @Get(':comment_id')
    async getCommentReplies(@Param('comment_id', ObjectIdValidationPipe) comment_id: string) {
    ...
    async updateReply(
        ...
        const reply = await this.repliesService.updateReply(reply_id, reply_by, updateReplyDto);
    ...
    async deleteReply(
        ...
        await this.repliesService.deleteReply(reply_id, reply_by);
